...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        m.reply(`「 *ANTI LINK* 」\n\n*Kamu terdeteksi mengirim link group*,*,yang mau juga silahkan kirim link‼️*`)
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            break
            case 'sc': {
                m.reply('https://wa.me/6281271010619')
            }
            break		 
            case '-': {
            let jawab = `*${ucapanWaktu}*\n*-*`
            let buttons = [{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: '-', buttonText: { displayText: '-' }, type: 1 }]
            let buttonMessage = {
...
let buttons = [{ buttonId: '-', buttonText: { displayText: '-' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 }]
...
│
╰────❍`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: '-', buttonText: { displayText: 'aku suka dengan nana' }, type: 1 }]
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: '-:, buttonText: { displayText: '-' }, type: 1 }]
            let buttonMessage = {
  document: fs.readFileSync('./media/doc/fake.pptx'),
  fileName : akulaku + (` | Halo ${pushname}`),
  mimetype: `${filsk}`,
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           title: ' ∫ » Owner? –––––––·•',
	           rows: [
	            {title: "〽️ • -", rowId: `donasi`, description: `kosong`},
	           ...
	           title: ' ∫ » Menu Kosong –––––––·•',
	           rows: [
	            {title: "🎟 • kosong", rowId: `donasi`, description: `╰ ► 💰 kosong ♕︎`},
                {title: "🔴 • kosong", rowId: `subsyt`, description: `╰ ► 📢 kosong ♕︎`},
                {title: "📚 • kosong", rowId: `sc`, description: `╰ ► 🎷 kosong ♕︎`}
	]
  },
]
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*${ucapanWaktu}*`, `Touch Me (⁠≧⁠▽⁠≦⁠)`, sections, fkontak)
